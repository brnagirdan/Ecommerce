...
namespace CmsShoppingCart.Controllers
{
    public class CartController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Sale(String Name, String Surname, String Address, String Country, String PostCode, String Telephone)
        {
            ...
            if (id != null)
            {
                response = "Bilgiler kaydedildi";
            }
            else
                response = "Bilgiler kaydedilirken hata oluştu";
            // Return response
            return View("Payment");
        }
